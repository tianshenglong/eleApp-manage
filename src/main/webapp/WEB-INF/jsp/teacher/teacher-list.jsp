        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="form-inline">
                        <a class="btn btn-primary" onclick="addTeacher('添加教师','/teacher/toTeacherAdd')" href="javascript:void(0);"><i class="fa fa-plus"></i> 添加教师</a>
                        <a href="javascript:void(0);" onclick="delTeacher()" class="btn btn-primary"><i class="fa fa-trash-o"></i> 批量删除</a>
                    </div>
                </div>
